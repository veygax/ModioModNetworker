...
namespace ModioModNetworkerUpdater
{
    ...
    public class ModioModNetworkerUpdaterPlugin : MelonPlugin
    {
        ...
        public override void OnPreInitialization()
        {
            ...
            LoggerInstance.Msg((ConsoleColor)(IsOffline ? ConsoleColor.Yellow : ConsoleColor.Green), IsOffline ? "Mod Io Mod Networker Auto-Updater is OFFLINE." : "Mod Io Mod Networker is ONLINE.");
